 ...
 */
@Stateless
public class IssueConfirmationService implements IssueConfirmationServiceLocal {
    ...
    private LibraryServiceEvent newIssueEvent;

    public IssueConfirmationService() {
//        InitialContext jndi;
//        try {
...
//        }
    ...
    public void processConfirmationRequest(Object object) {
        if (object != null) {
            this.newIssueEvent = (LibraryServiceEvent) object;
    ...
    private void pushConfirmationRequest() {
        ...
        try {
            ...
            message = session.createObjectMessage(newIssueEvent);
